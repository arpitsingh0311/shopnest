...
import com.ecommerce.shopnest.model.Cart;
import com.ecommerce.shopnest.model.CartItem;
import com.ecommerce.shopnest.model.Product;
import com.ecommerce.shopnest.payload.CartDTO;
import com.ecommerce.shopnest.payload.ProductDTO;
import com.ecommerce.shopnest.repositories.CartItemRepository;
import com.ecommerce.shopnest.repositories.CartRepository;
import com.ecommerce.shopnest.repositories.ProductRepository;
import com.ecommerce.shopnest.util.AuthUtil;
...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if(cartItem!=null){
            throw new APIException("Produt "+ product.getProductName() + " already exists in cart.");
        }
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if(newQuantity<0) throw new APIException("The resulting quatity can't be negative.");
        ...
        if(updatedItem.getQuantity() == 0){
            cartItemRepository.deleteById(updatedItem.getCartId());
        }
